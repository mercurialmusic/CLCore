...
public class ResourcePackSetUsingResourcePackCommand extends SubCommand {
    
    private ResourcePackManager manager;
    
    public ResourcePackSetUsingResourcePackCommand(CLCore plugin, ResourcePackManager manager) {
    ...
    protected String execute(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        manager.setUsingResourcePack(bool);
